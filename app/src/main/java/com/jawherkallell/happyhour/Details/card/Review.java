...
public class Review {
    ...
    public Review(String time, String text, String profile_photo_url, String relative_time_description, String author_url, String author_name, String rating, String language) {
        this.time = time;
        this.text = text;
